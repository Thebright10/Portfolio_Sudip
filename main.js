...
// Log visitor to Flask backend
function logVisitor(tabName = "") {
	fetch("http://127.0.0.1:5000/log-visitor", {
		method: "POST",
		headers: { "Content-Type": "application/json" },
		body: JSON.stringify({ section: tabName, action: "tab_open", success: true })
	})
	.then(res => res.json())
